  ...
  <div>
    ...
    <b-row v-if="!loading" class="animated fadeIn">
      <b-col :lg="12">
        ...
        <!-- <b-button class="mb-2" @click="create" variant="primary">Add new Order</b-button> -->
      </b-col>
        ...
        <b-card class="card-accent-info" :header="'Detail of `' + current.Title + '`'">
          <b-form>
            ...
            <b-form-group v-for="field in fields" :key="field.key">
              <b-input-group
                v-if="['Code', 'Status', 'Shipping Fee', 'ID', 'Channel', 'NoteForDeliver'].indexOf(field.key) === -1"
              >
                <b-input-group-prepend>
            ...
            <b-form-group>
              <b-input-group>
                ...
                <b-form-input type="text" v-model="current.Code"></b-form-input>
              </b-input-group>
            </b-form-group>
            ...
            <b-form-group>
              <b-input-group>
                <b-input-group-prepend>
                  <b-input-group-text>Shipping Fee</b-input-group-text>
                </b-input-group-prepend>
                <b-form-input type="text" v-model="current.ShippingFee"></b-form-input>
              </b-input-group>
            </b-form-group>
            ...
            <b-form-group>
              <b-input-group>
                <b-input-group-prepend>
                  <b-input-group-text>Channel</b-input-group-text>
                </b-input-group-prepend>
                <b-form-input type="text" v-model="current.Channel"></b-form-input>
              </b-input-group>
            </b-form-group>
            ...
            <b-form-group>
              <b-input-group>
                <b-input-group-prepend>
                  <b-input-group-text>Note for Deliver</b-input-group-text>
                </b-input-group-prepend>
                <b-form-input type="text" v-model="current.NoteForDeliver"></b-form-input>
              </b-input-group>
            </b-form-group>
            <!-- <b-form-group>
              <b-input-group>
            ...
            <!-- <b-form-group>
              <b-input-group>
                <b-input-group-prepend>
                  <b-input-group-text>Image URL</b-input-group-text>
                </b-input-group-prepend>
