...
namespace API.Controllers
{
    public class NewsController : ApiController
    {
        ...
        public IHttpActionResult PutNews(int id, News news)
        {
            ...
            News queryNews = db.News.Where(n => n.ID == news.ID).FirstOrDefault();
            db.Entry(queryNews).CurrentValues.SetValues(news);
            db.Entry(queryNews).State = EntityState.Modified;
