...
namespace API
{
    ...
    public class ApplicationUserManager : UserManager<Account>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<Account>(context.Get<EntityConnection>()));
    ...
    public class ApplicationRoleManager : RoleManager<IdentityRole>
    {
        ...
        {
            var appRoleManager = new ApplicationRoleManager(new RoleStore<IdentityRole>(context.Get<EntityConnection>()));
